    ...
    public class Employee
    {
        ...
        public static List<Employee> GetEmployees()
        {
            List<Employee> employees = new List<Employee>
            {
                ...
                new Employee {ID = 102, FirstName = "Priyanka", LastName = "Dewangan", Salary = 70000 },
                new Employee {ID = 103, FirstName = "Hina", LastName = "Sharma", Salary = 80000 },
                new Employee {ID = 101, FirstName = "Prem", LastName = "Kiwary", Salary = 60000 },
                new Employee {ID = 102, FirstName = "Prerana", LastName = "Levagan", Salary = 70000 },
                new Employee {ID = 103, FirstName = "Mahina", LastName = "verma", Salary = 80000 }
            };
            return employees;
        }
    }
